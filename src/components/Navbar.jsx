      ...
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        >
          <img
            src={logo}
            alt="logo"
            className="w-[2.45rem] h-[2.65rem] object-contain rounded-full"
          />
          <p className="text-white text-[18px] font-bold cursor-pointer flex ">
            Sarthak
            <span className="sm:block hidden ml-1">| Full Stack Developer</span>
          </p>
        </Link>
        ...
        <ul className="list-none hidden sm:flex flex-row gap-10">
          ...
          <li className="hover:text-white text-[18px] font-medium cursor-pointer text-secondary">
            <a href={cv} download="Sarthak_Resume">
              Download CV
            </a>
          </li>
        </ul>
